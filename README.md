...
int main() {
    // Read input image
    Mat image = imread("spi.jpg", IMREAD_COLOR);
...
## OUTPUT:
<img width="652" height="373" alt="image" src="https://github.com/user-attachments/assets/7502b884-b49f-4a28-88ea-d03cc958bde5" />
